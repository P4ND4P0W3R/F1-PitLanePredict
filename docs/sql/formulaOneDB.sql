...
CREATE TABLE
    IF NOT EXISTS "Users" (
        ...
        country VARCHAR(50),
        "userType" VARCHAR(10) DEFAULT 'regular' CHECK (
            "userType" IN ('regular', 'admin')
        )
    );
...
CREATE TABLE
    IF NOT EXISTS "Bets" (
        ...
        "betStatus" VARCHAR(10) DEFAULT 'pending' CHECK (
            "betStatus" IN ('pending', 'won', 'lost')
        ),
        "createdAt" TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    );
...
VALUES (
        ...
        '1995-02-06',
        'Dutch',
        'https://en.wikipedia.org/wiki/Nyck_de_Vries',
        'image.png',
        'alphatauri'
    ), (
        'gasly',
        ...
        '2002-02-11',
        'New Zealander',
        'https://en.wikipedia.org/wiki/Liam_Lawson',
        'image.png',
        'alphatauri'
    ), (
        'leclerc',
        ...
        '1992-10-05',
        'Danish',
        'https://en.wikipedia.org/wiki/Kevin_Magnussen',
        'image.png',
        'haas'
    ), (
        'norris',
        ...
        '2000-12-31',
        'American',
        'https://en.wikipedia.org/wiki/Logan_Sargeant',
        'image.png',
        'williams'
    ), (
        'stroll',
